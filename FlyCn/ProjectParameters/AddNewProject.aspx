<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/IframePage.Master" AutoEventWireup="true" CodeBehind="AddNewProject.aspx.cs" Inherits="FlyCn.ProjectParameters.AddNewProject" %>
                                            ...
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <cc1:FilteredTextBoxExtender ID="FilteredCmpnyTelephone" runat="server" Enabled="True" TargetControlID="txtCmpnyTelephone" FilterType="Numbers" FilterMode="ValidChars"></cc1:FilteredTextBoxExtender>
                                                ...
                                                <table style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <cc1:FilteredTextBoxExtender ID="FilteredClientTelephone" runat="server" Enabled="True" TargetControlID="txtClientTelephone" FilterType="Numbers" FilterMode="ValidChars"></cc1:FilteredTextBoxExtender>
                                                        </td>
