<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/IframePage.Master" AutoEventWireup="true" CodeBehind="ModuleActivities.aspx.cs" Inherits="FlyCn.FlycnSecurity.ModuleActivities" %>
...
<div class="col-md-12"  >
          <div style="float:left; width:47%;">
            ...
            <asp:Label ID="lblManageActivities" runat="server" Text="Module Activities" CssClass="PageHeading"></asp:Label>
                  </div> 
             <br />
      <br />
                <div class="col-md-12">
                       ...
                       <asp:ListItem Text="--select project--"></asp:ListItem>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-md-6">
                                <asp:DropDownList ID="ddlSelectModule" runat="server" Width="150px" CssClass="selectbox" AppendDataBoundItems="false" AutoPostBack="true">
                       <asp:ListItem Text="--select module--"></asp:ListItem>
                 </asp:DropDownList>
                                </div>
                            </div>
